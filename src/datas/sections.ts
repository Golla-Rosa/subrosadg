...
export const sections: Section[] = [
    {
      ...
      body: `Subrosa is dedicated to becoming a guild of digital artists
       and craftsmen. We believe that, as 
       actors in the digital world, 
       we have the opportunity to live independently 
       through our ideas and skills, and to use our talents to impact the world in positive ways.      However, we also recognize that exploring the paths of independence or activism alone can be dangerous. In order to address this, we are forming a guild where members can help each other on projects, share knowledge and reflections, and support each other in our endeavors. By working together, we can achieve greater success and resilience in the face of challenges.
